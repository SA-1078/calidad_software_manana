// ESTE ARCHIVO VA EN EL REPOSITORIO DE CALIDAD DE SOFTWARE DENTRO DE LA CARPETA LEARNING-JEST Y 
// DENTRO DE LA SUBCARPETA CICLOS

const { sumaHasta } = require('./sumaHasta');

describe('sumaHasta', ()=>{

    test('Happy path: numero 5 suma es 15', () => {
        expect(sumaHasta(5)).toBe(15); 
    });

    test('Happy path: numero 1 suma es 1', () => {
